...
- [x] 2026-09-15 — Folded recursive-delete path check into `rules/user/behavior.md` (resolve FullName; no ask if inside workspace and not drive root/home/ReparsePoint; extra-workspace only if user named the path this turn).
  - Source: `articles/recursive-delete-drive-root.md`
